...
import com.tsxy.carl.config.Constants;
import com.tsxy.carl.RegistrationBookApp;
import com.tsxy.carl.domain.Authority;
import com.tsxy.carl.domain.User;
import com.tsxy.carl.repository.AuthorityRepository;
import com.tsxy.carl.repository.UserRepository;
import com.tsxy.carl.security.AuthoritiesConstants;
import com.tsxy.carl.service.MailService;
import com.tsxy.carl.service.dto.UserDTO;
import com.tsxy.carl.web.rest.errors.ExceptionTranslator;
import com.tsxy.carl.web.rest.vm.KeyAndPasswordVM;
import com.tsxy.carl.web.rest.vm.ManagedUserVM;
import com.tsxy.carl.service.UserService;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ManagedUserVM validUser = new ManagedUserVM(
            ...
            "Joe",                  // firstName
            "Shmoe",                // lastName
            15230515282L,           // mobilePhone
            "130181199310166473",           // idCard
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(), validUser.getPassword(), validUser.getFirstName(), validUser.getLastName(),
            validUser.getMobilePhone(), validUser.getIdCard(),
